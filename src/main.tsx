...
function EvidenceLibrary({ workspace }: { workspace: Workspace }) {
  const [sources, setSources] = useState<SourceDocument[]>([]); const [busy, setBusy] = useState(false); const [message, setMessage] = useState(''); const [copyMessage, setCopyMessage] = useState('')
